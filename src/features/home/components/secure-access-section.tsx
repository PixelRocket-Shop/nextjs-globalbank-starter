    ...
    <section className="relative py-24 overflow-hidden">
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap items-center -m-8">
              ...
              <ul>
                {features.map((feature, index) => (
                  <li key={index} className="inline-flex mb-3.5">
                    <Image className="mr-3.5" src="/images/checked.svg" alt="" width={16} height={16} />
          ...
          <div className="w-full md:w-1/2 p-8">
            <Image className="mx-auto" src="/images/card2.png" alt="" width={400} height={300} />
          </div>
        </div>
      </div>
      <Image className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" src="/images/bg-blur.png" alt="" width={600} height={400} />
    </section>
  );
};
