...
const TestimonialsSection: React.FC = () => {
  ...
  const initialTestimonials = data.initialTestimonials;
  const hiddenTestimonials = data.hiddenTestimonials;
    ...
    <section className="relative py-24 overflow-hidden">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap -m-3">
          {(['column1', 'column2', 'column3', 'column4'] as const).map((columnKey) => (
